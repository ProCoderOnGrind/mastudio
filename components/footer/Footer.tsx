  ...
  return (
    <footer className="mt-24 px-5 pb-10">
      <div className="grid gap-x-10 md:grid-cols-4">
        <Accordion title="Contact" staticOnDesktop>
